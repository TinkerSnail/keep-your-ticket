...
## covers the ones not written yet, and this directory turns over: the probes are
## written for one question each, and two of them have since been promoted to
## standing tools under new names. A scene file per tool is a second thing to
## remember to delete.
##
