...
| `_palm_inventory_probe.gd` | What the coastal palm and landscaping builders leave visible at runtime: mesh nodes, surfaces, distinct meshes and materials per output group and for one palm. Headless. Shows whether `scripts/static_merge.gd` ran. |
